            ...
            <form method="post" id="addForm" action="/addStudent" role="form">
                ...
                <tr class="submitTR">
                    <td colspan="1" align="center">
                        <a class="btn btn-danger btn-lg btn-block" href="${pageContext.request.contextPath}/StudentList" role="button">查看学生信息</a>
                    </td>
                    <td>
                        <a class="btn btn-info btn-lg btn-block" href="${pageContext.request.contextPath}/findStudent" role="button">查询学生信息</a>
                    </td>
